"""
Django settings for super_glitter_dev_80730 project.
...
ROOT_URLCONF = 'super_glitter_dev_80730.urls'
...
WSGI_APPLICATION = 'super_glitter_dev_80730.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_glitter_dev_80730 API",
    "DESCRIPTION": "API documentation for super_glitter_dev_80730 App",
    "VERSION": "v1",
}
